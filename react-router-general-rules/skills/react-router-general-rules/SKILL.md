---
name: react-router-general-rules
description: Explains how to use React Router framework mode resources. Use only when working with React Router v7 or later in framework mode, or when the user asks about resources in framework mode.
---
